...
export default function Footer() {
  return (
    <footer className="bg-[var(--bg)] text-[var(--secondary-text)] text-sm">
      {/* Main Footer Grid */}
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-start md:items-center space-y-8 md:space-y-0">
        ...
        <div className="flex flex-col gap-2">
          <h4 className="font-semibold text-[var(--primary-text)] mb-2">Quick Links</h4>
          <Link href="/" className="hover:text-[var(--accent)] transition">
            Home
          </Link>
          <Link href="/resources" className="hover:text-[var(--accent)] transition">
            Resources
          </Link>
          <Link href="/form" className="hover:text-[var(--accent)] transition">
            Form
          </Link>
        ...
        {/* Column 2: Hours */}
        <div className="flex flex-col gap-2">
          <h4 className="font-semibold text-[var(--primary-text)] mb-2">Hours of Operation</h4>
        ...
        <div className="flex flex-col gap-2 w-full md:w-auto">
          <h4 className="font-semibold text-[var(--primary-text)] mb-2">Find Us</h4>
          <div className="w-full md:w-64 h-36 rounded-lg overflow-hidden border border-[var(--border)]">
            <iframe
      ...
      <div className="border-t border-[var(--border)] bg-[var(--surface)] py-4">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-[var(--secondary-text)] text-sm">
