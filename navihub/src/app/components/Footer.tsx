      ...
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-start md:items-center space-y-8 md:space-y-0">
        <div className="flex flex-col gap-2">
          ...
          <Link href="/pages/about" className="footer-link">
            About
    <footer className="bg-[#1F1F1F] text-gray-300 pt-16 pb-0 mt-auto w-full">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-12">
        ...
        <div className="flex flex-col gap-3 w-full">
          ...
          <p className="text-xs text-gray-400 leading-relaxed mb-1">
            Not sure where to start? Let NaviBot, our AI community assistant, help you find exactly what youre looking for.
          </p>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-6 py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-gray-500">
          <p className="text-[4px] md:text-xs">© {new Date().getFullYear()} TSA Webmaster. All rights reserved.</p>
