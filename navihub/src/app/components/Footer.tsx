...
export default function Footer() {
  return (
    <footer className="bg-(--bg)] text-[var(--secondary-text) text-sm">
      {/* Main Footer Grid */}
      <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col md:flex-row justify-between items-start md:items-center space-y-8 md:space-y-0">
        ...
        <div className="flex flex-col gap-2">
          <h4 className="font-semibold text-(--primary-text) mb-2">Quick Links</h4>
        ...
        {/* Column 2: Hours */}
        <div className="flex flex-col gap-2">
          <h4 className="font-semibold text-(--primary-text) mb-2">Hours of Operation</h4>
        ...
        <div className="flex flex-col gap-2 w-full md:w-auto">
          <h4 className="font-semibold text-(--primary-text) mb-2">Find Us</h4>
